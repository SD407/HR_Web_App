...
public abstract class BaseCompanyServiceTest {
	...
	public void addCompany() {
		...
		jobList.add(createJobDescriptionObject(
				JobDescription.CurrentJobTitle.BA,
				JobDescription.YearsOfExperience.ZERO_TO_ONE, 
				JobDescription.Location.CLUJ_NAPOCA,
				JobDescription.ProfessionalSkills.JAVA, 
				JobDescription.PersonalSkills.TEAM_PLAYER));
		Company company = createObjectFromCompany(
				"nokia", 
				"nokya", 
				"phones", 
				"nokia.emp@yahoo.com", 
	...
	public void deleteCompany() {
		...
		jobList.add(createJobDescriptionObject(
				...
				JobDescription.ProfessionalSkills.JAVA, 
				JobDescription.PersonalSkills.TEAM_PLAYER));
		Company companyToDelete = createObjectFromCompany(
				"endava", 
				"nokya", 
				"phones", 
				"nokia.emp@yahoo.com", 
		...
		// when
		getValidator().validate(companyToDelete, errors); //validate fields from company
	...
	public void getCompany() {
		...
		jobList.add(createJobDescriptionObject(
				...
				JobDescription.ProfessionalSkills.JAVA, 
				JobDescription.PersonalSkills.TEAM_PLAYER));
		Company comp1 = createObjectFromCompany(
				"endava",
				"nokya",
				"phones",
				"nokia.emp@yahoo.com",
				...
				jobList,
				"Cluj-Napoca");
		Company comp2 = createObjectFromCompany(
				"bosh",
				"nokya",
				"phones", 
				"nokia.emp@yahoo.com",
	...
	public void test_add_no_company_name() {
		...
		Errors errors = new BeanPropertyBindingResult(company, "company");
		//when
		getValidator().validate(company, errors); //validate fields from company
		getCompanyService().saveCompany(company);
		//then
	...
	private JobDescription createJobDescriptionObject(
			CurrentJobTitle ba, 
			YearsOfExperience zeroToOne,
			Location clujNapoca, 
			ProfessionalSkills java, 
			PersonalSkills teamPlayer) {
	...
	private Company createObjectFromCompany(
			String companyName, 
			String userName, 
			String password, 
			String email,
